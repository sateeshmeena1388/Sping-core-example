...
public static void main(String[] args) {
	...
	//default advisor
	DefaultPointcutAdvisor pmAdvisor=new DefaultPointcutAdvisor(new CommonDynaPointcut(),new CacheAdvice());
	DefaultPointcutAdvisor cacheAdvice=new DefaultPointcutAdvisor(new CommonDynaPointcut(),new CacheAdvice());
	facttory.addAdvisor(0,cacheAdvice);
	facttory.addAdvisor(1,pmAdvisor);
	//get proxy object
