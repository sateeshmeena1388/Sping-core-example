...
private static final String GET_EMP_DETAILS_BY_DESG="SELECT EMPID,ENAME,JOB,SAL FROM EMP WHERE JOB=:desg";
@Resource
...
@Override
	...
	count=npjt.queryForObject(Get_EMP_COUNT,new HashMap(), Integer.class);
		return count;
	}
	...
	public List<EmployeeBo> getEmpdetailsByDesg(String desg) {
		...
		npjt.query(GET_EMP_DETAILS_BY_DESG,paramMap,new EmployeeRowCallBackHandler(listbo));
		return listbo;
	}
